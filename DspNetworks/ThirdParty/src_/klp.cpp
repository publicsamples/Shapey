...
struct _klp final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow6 = 1.0f / (1.0f - 0.21521823f * (fSlow5 * fSlow0 / fSlow1));
		float fSlow7 = 1.0f / fSlow1;
		float fSlow8 = 0.21521823f * fSlow5;
		float fSlow9 = 0.21521823f * fSlow4;
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			float fTemp0 = float(input0[i0]) - fRec0[1];
			fRec0[0] = fRec0[1] + fSlow3 * fTemp0;
			float fTemp1 = fSlow6 * (fSlow7 * (fSlow0 * fTemp0 + fSlow8 * fRec1[1] - fRec2[1]) + fRec0[1]) - fRec1[1];
