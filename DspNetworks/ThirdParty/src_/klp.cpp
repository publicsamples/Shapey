...
struct _klp final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp1 = fSlow6 * (fRec0[1] + fSlow7 * (fSlow0 * fTemp0 + fSlow8 * fRec1[1] - fRec2[1])) - fRec1[1];
			fRec1[0] = fRec1[1] + fSlow3 * fTemp1;
			float fTemp2 = fRec1[1] + fSlow2 * fTemp1;
			fRec2[0] = fRec2[1] + fSlow3 * (fSlow9 * fTemp2 - fRec2[1]);
			float fRec3 = fTemp2;
			output0[i0] = FAUSTFLOAT(fRec3);
			float fTemp3 = float(input1[i0]) - fRec4[1];
			fRec4[0] = fRec4[1] + fSlow3 * fTemp3;
			float fTemp4 = fSlow6 * (fRec4[1] + fSlow7 * (fSlow0 * fTemp3 + fSlow8 * fRec5[1] - fRec6[1])) - fRec5[1];
			fRec5[0] = fRec5[1] + fSlow3 * fTemp4;
			float fTemp5 = fRec5[1] + fSlow2 * fTemp4;
			fRec6[0] = fRec6[1] + fSlow3 * (fSlow9 * fTemp5 - fRec6[1]);
			float fRec7 = fTemp5;
