...
Compilation options: -lang cpp -rui -nvi -ct 1 -cn _salenLP -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */

#ifndef  ___salenLP_H__
#define  ___salenLP_H__
...
struct _salenLP final : public ::faust::dsp {
	...
	void metadata(Meta* m) { 
		m->declare("compile_options", "-lang cpp -rui -nvi -ct 1 -cn _salenLP -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
		m->declare("filename", "salenLP.dsp");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.8.0");
		m->declare("name", "salenLP");
	...
	void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("salenLP");
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp1 = fSlow4 * fTemp0 + fRec1[1];
			fRec0[0] = fSlow1 * fTemp1 + fRec0[1];
			float fTemp2 = fSlow5 * fTemp0 + fRec1[1];
			fRec1[0] = fTemp2;
			float fRec2 = fSlow0 * fTemp2 + fRec0[1];
			...
			fRec4[0] = fTemp5;
			float fRec5 = fRec3[1] + fSlow0 * fTemp5;
	...
	#define FAUST_FILE_NAME "salenLP.dsp"
	#define FAUST_CLASS_NAME "_salenLP"
	#define FAUST_COMPILATION_OPIONS "-lang cpp -rui -nvi -ct 1 -cn _salenLP -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0"
