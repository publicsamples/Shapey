...
struct _khp2 final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			float fTemp0 = float(input0[i0]) - (fRec2[1] + fSlow1 * fRec1[1]);
			float fRec0 = fSlow3 * fTemp0;
			float fTemp1 = fSlow5 * fTemp0 + fRec1[1];
			fRec1[0] = fTemp1;
			float fTemp2 = fSlow4 * fTemp0 + fRec1[1];
			fRec2[0] = fSlow6 * fTemp2 + fRec2[1];
			output0[i0] = FAUSTFLOAT(fRec0);
			float fTemp3 = float(input1[i0]) - (fRec5[1] + fSlow1 * fRec4[1]);
			float fRec3 = fSlow3 * fTemp3;
			float fTemp4 = fRec4[1] + fSlow5 * fTemp3;
			fRec4[0] = fTemp4;
			float fTemp5 = fRec4[1] + fSlow4 * fTemp3;
			fRec5[0] = fRec5[1] + fSlow6 * fTemp5;
