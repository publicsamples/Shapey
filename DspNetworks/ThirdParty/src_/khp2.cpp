...
struct _khp2 final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			float fTemp0 = float(input0[i0]) - (fRec0[1] + fSlow2 * fRec2[1]);
			float fTemp1 = fRec2[1] + fSlow4 * fTemp0;
			fRec0[0] = fRec0[1] + fSlow1 * fTemp1;
			float fRec1 = fSlow5 * fTemp0;
			float fTemp2 = fRec2[1] + fSlow6 * fTemp0;
			fRec2[0] = fTemp2;
			output0[i0] = FAUSTFLOAT(fRec1);
			float fTemp3 = float(input1[i0]) - (fRec3[1] + fSlow2 * fRec5[1]);
			float fTemp4 = fRec5[1] + fSlow4 * fTemp3;
			fRec3[0] = fRec3[1] + fSlow1 * fTemp4;
			float fRec4 = fSlow5 * fTemp3;
