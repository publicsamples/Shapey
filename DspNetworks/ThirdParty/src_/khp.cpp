...
struct _khp final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp2 = fTemp0 - (fRec2[1] + fSlow6 * (fSlow0 * fTemp1 - fRec3[1] + fSlow3 * fRec1[1]));
			float fRec0 = fSlow5 * fTemp2;
			float fTemp3 = fSlow8 * fTemp2;
			float fTemp4 = fTemp3 - fRec1[1];
			fRec1[0] = fRec1[1] + fSlow7 * fTemp4;
			fRec2[0] = fRec2[1] + fSlow7 * fTemp1;
			fRec3[0] = fRec3[1] + fSlow7 * (fTemp3 - (fSlow3 * fTemp4 + fRec3[1] + fRec1[1]));
			output0[i0] = FAUSTFLOAT(fRec0);
			float fTemp5 = float(input1[i0]);
			float fTemp6 = fTemp5 - fRec6[1];
			float fTemp7 = fTemp5 - (fSlow6 * (fSlow0 * fTemp6 - fRec7[1] + fSlow3 * fRec5[1]) + fRec6[1]);
			float fRec4 = fSlow5 * fTemp7;
			float fTemp8 = fSlow8 * fTemp7;
			float fTemp9 = fTemp8 - fRec5[1];
			fRec5[0] = fRec5[1] + fSlow7 * fTemp9;
			fRec6[0] = fSlow7 * fTemp6 + fRec6[1];
			fRec7[0] = fSlow7 * (fTemp8 - (fRec5[1] + fSlow3 * fTemp9 + fRec7[1])) + fRec7[1];
