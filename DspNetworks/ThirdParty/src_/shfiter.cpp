...
struct _shfiter final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			int iTemp2 = std::min<int>(65537, std::max<int>(0, iTemp1 + 1));
			float fTemp3 = std::floor(fRec0[0]);
			float fTemp4 = fRec0[0] - fTemp3;
			int iTemp5 = std::min<int>(65537, std::max<int>(0, iTemp1));
			...
			float fTemp13 = fTemp12 + fTemp6 - fSlow0;
			float fTemp14 = fSlow0 + (fRec0[0] - fTemp12);
			int iTemp15 = std::min<int>(65537, std::max<int>(0, iTemp10 + 1));
			float fTemp16 = 1.0f - fTemp8;
			output0[i0] = FAUSTFLOAT((fVec0[(IOTA0 - iTemp2) & 131071] * fTemp4 + fVec0[(IOTA0 - iTemp5) & 131071] * fTemp7) * fTemp8 + (fVec0[(IOTA0 - iTemp11) & 131071] * fTemp13 + fTemp14 * fVec0[(IOTA0 - iTemp15) & 131071]) * fTemp16);
			float fTemp17 = float(input1[i0]);
			fVec1[IOTA0 & 131071] = fTemp17;
			output1[i0] = FAUSTFLOAT(fTemp8 * (fVec1[(IOTA0 - iTemp2) & 131071] * fTemp4 + fVec1[(IOTA0 - iTemp5) & 131071] * fTemp7) + fTemp16 * (fTemp13 * fVec1[(IOTA0 - iTemp11) & 131071] + fTemp14 * fVec1[(IOTA0 - iTemp15) & 131071]));
			IOTA0 = IOTA0 + 1;
			fRec0[1] = fRec0[0];
		}
	}
