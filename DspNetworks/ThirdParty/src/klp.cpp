...
struct _klp final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow6 = 1.0f / (1.0f - 0.21521823f * ((1.0f - fSlow2) * fSlow0 * fSlow4 / fSlow1));
		float fSlow7 = 1.0f / fSlow1;
		float fSlow8 = 0.21521823f * (fSlow2 + -1.0f) * fSlow4;
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			float fTemp0 = float(input0[i0]) - fRec0[1];
			fRec0[0] = fRec0[1] + fSlow3 * fTemp0;
			float fTemp1 = fSlow6 * (fSlow7 * (fSlow0 * fTemp0 - fSlow8 * fRec2[1] - fRec1[1]) + fRec0[1]) - fRec2[1];
			float fTemp2 = fSlow2 * fTemp1 + fRec2[1];
			fRec1[0] = fRec1[1] + fSlow3 * (fSlow5 * fTemp2 - fRec1[1]);
			fRec2[0] = fSlow3 * fTemp1 + fRec2[1];
			float fRec3 = fTemp2;
			output0[i0] = FAUSTFLOAT(fRec3);
			float fTemp3 = float(input1[i0]) - fRec4[1];
			fRec4[0] = fRec4[1] + fSlow3 * fTemp3;
			float fTemp4 = fSlow6 * (fRec4[1] + fSlow7 * (fSlow0 * fTemp3 - fSlow8 * fRec6[1] - fRec5[1])) - fRec6[1];
			float fTemp5 = fRec6[1] + fSlow2 * fTemp4;
			fRec5[0] = fRec5[1] + fSlow3 * (fSlow5 * fTemp5 - fRec5[1]);
			fRec6[0] = fRec6[1] + fSlow3 * fTemp4;
			float fRec7 = fTemp5;
