...
struct _klp final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow5 = 0.21521823f * fSlow4;
		float fSlow6 = 1.0f - fSlow2;
		float fSlow7 = 1.0f / (1.0f - 0.21521823f * (fSlow0 * fSlow4 * fSlow6 / fSlow1));
		float fSlow8 = 1.0f / fSlow1;
		float fSlow9 = 0.21521823f * fSlow4 * fSlow6;
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			float fTemp0 = float(input0[i0]) - fRec1[1];
			float fTemp1 = fSlow7 * (fRec1[1] + fSlow8 * (fSlow0 * fTemp0 + fSlow9 * fRec2[1] - fRec0[1])) - fRec2[1];
			float fTemp2 = fRec2[1] + fSlow2 * fTemp1;
			fRec0[0] = fSlow3 * (fSlow5 * fTemp2 - fRec0[1]) + fRec0[1];
			fRec1[0] = fSlow3 * fTemp0 + fRec1[1];
			fRec2[0] = fSlow3 * fTemp1 + fRec2[1];
			float fRec3 = fTemp2;
			output0[i0] = FAUSTFLOAT(fRec3);
			float fTemp3 = float(input1[i0]) - fRec5[1];
			float fTemp4 = fSlow7 * (fRec5[1] - fSlow8 * (fRec4[1] - (fSlow0 * fTemp3 + fSlow9 * fRec6[1]))) - fRec6[1];
			float fTemp5 = fSlow2 * fTemp4 + fRec6[1];
			fRec4[0] = fSlow3 * (fSlow5 * fTemp5 - fRec4[1]) + fRec4[1];
			fRec5[0] = fRec5[1] + fSlow3 * fTemp3;
			fRec6[0] = fSlow3 * fTemp4 + fRec6[1];
			float fRec7 = fTemp5;
