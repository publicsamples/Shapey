...
struct _OBBPF final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp4 = float(input1[i0]) - (fRec3[1] + fSlow2 * fRec4[1]);
			float fTemp5 = fSlow4 * fTemp4;
			float fTemp6 = std::max<float>(-1.0f, std::min<float>(1.0f, fRec4[1] + fTemp5));
			float fTemp7 = fTemp6 * (1.0f - 0.33333334f * _OBBPF_faustpower2_f(fTemp6));
			fRec3[0] = fRec3[1] + fSlow1 * fTemp7;
			fRec4[0] = fTemp5 + fTemp7;
			float fRec5 = fTemp7;
