...
struct _khp2 final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			float fTemp0 = float(input0[i0]) - (fRec1[1] + fSlow1 * fRec0[1]);
			float fTemp1 = fRec0[1] + fSlow4 * fTemp0;
			fRec0[0] = fTemp1;
			float fTemp2 = fRec0[1] + fSlow3 * fTemp0;
			fRec1[0] = fRec1[1] + fSlow5 * fTemp2;
			float fRec2 = fSlow6 * fTemp0;
			output0[i0] = FAUSTFLOAT(fRec2);
			float fTemp3 = float(input1[i0]) - (fRec4[1] + fSlow1 * fRec3[1]);
			float fTemp4 = fRec3[1] + fSlow4 * fTemp3;
			fRec3[0] = fTemp4;
			float fTemp5 = fRec3[1] + fSlow3 * fTemp3;
			fRec4[0] = fRec4[1] + fSlow5 * fTemp5;
