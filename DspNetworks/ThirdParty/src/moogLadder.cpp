...
struct _moogLadder final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow6 = 0.1646572f * fSlow4 * (1.0f - fSlow2);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			float fTemp0 = fSlow5 * (float(input0[i0]) - fSlow6 * (fRec3[1] + fSlow2 * (fSlow2 * (fRec1[1] + fSlow2 * fRec0[1]) + fRec2[1]))) - fRec0[1];
			fRec0[0] = fSlow3 * fTemp0 + fRec0[1];
			float fTemp1 = fSlow2 * fTemp0 + fRec0[1] - fRec1[1];
			fRec1[0] = fSlow3 * fTemp1 + fRec1[1];
			float fTemp2 = fSlow2 * fTemp1 + fRec1[1] - fRec2[1];
			fRec2[0] = fSlow3 * fTemp2 + fRec2[1];
			float fTemp3 = fSlow2 * fTemp2 + fRec2[1] - fRec3[1];
			fRec3[0] = fRec3[1] + fSlow3 * fTemp3;
			float fRec4 = fRec3[1] + fSlow2 * fTemp3;
			output0[i0] = FAUSTFLOAT(fRec4);
			float fTemp4 = fSlow5 * (float(input1[i0]) - fSlow6 * (fRec8[1] + fSlow2 * (fRec7[1] + fSlow2 * (fRec6[1] + fSlow2 * fRec5[1])))) - fRec5[1];
			fRec5[0] = fRec5[1] + fSlow3 * fTemp4;
			float fTemp5 = fRec5[1] + fSlow2 * fTemp4 - fRec6[1];
			fRec6[0] = fRec6[1] + fSlow3 * fTemp5;
			float fTemp6 = fRec6[1] + fSlow2 * fTemp5 - fRec7[1];
			fRec7[0] = fRec7[1] + fSlow3 * fTemp6;
			float fTemp7 = fRec7[1] + fSlow2 * fTemp6 - fRec8[1];
			fRec8[0] = fRec8[1] + fSlow3 * fTemp7;
			float fRec9 = fRec8[1] + fSlow2 * fTemp7;
