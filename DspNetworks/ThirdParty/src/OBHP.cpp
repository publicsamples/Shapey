...
struct _OBHP final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow3 = fSlow2 * fSlow0 + 1.0f;
		float fSlow4 = fSlow0 / fSlow3;
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			float fTemp0 = float(input0[i0]) - (fRec0[1] + fSlow2 * fRec1[1]);
			float fTemp1 = fSlow4 * fTemp0;
			float fTemp2 = std::max<float>(-1.0f, std::min<float>(1.0f, fTemp1 + fRec1[1]));
			float fTemp3 = (1.0f - 0.33333334f * _OBHP_faustpower2_f(fTemp2)) * fTemp2;
			fRec0[0] = fSlow1 * fTemp3 + fRec0[1];
			fRec1[0] = fTemp3 + fTemp1;
			float fTemp4 = fSlow0 * fTemp3;
			float fRec2 = fTemp4 + fRec0[1];
