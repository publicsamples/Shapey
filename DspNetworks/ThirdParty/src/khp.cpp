...
struct _khp final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow4 = 1.0f - 0.21521823f * ((1.0f - fSlow2) * fSlow0 * fSlow3 / fSlow1);
		float fSlow5 = 1.0f / fSlow4;
		float fSlow6 = 1.0f / fSlow1;
		float fSlow7 = 2.0f * fSlow2;
		float fSlow8 = 0.21521823f * (fSlow3 / fSlow4);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			float fTemp0 = float(input0[i0]);
			float fTemp1 = fTemp0 - fRec3[1];
			float fTemp2 = fTemp0 - (fRec3[1] + fSlow6 * (fSlow0 * fTemp1 - fRec1[1] + fSlow2 * fRec2[1]));
			float fRec0 = fSlow5 * fTemp2;
			float fTemp3 = fSlow8 * fTemp2;
			float fTemp4 = fTemp3 - fRec2[1];
			fRec1[0] = fSlow7 * (fTemp3 - (fSlow2 * fTemp4 + fRec1[1] + fRec2[1])) + fRec1[1];
			...
			float fTemp7 = fTemp5 - (fSlow6 * (fSlow0 * fTemp6 - fRec5[1] + fSlow2 * fRec6[1]) + fRec7[1]);
			float fRec4 = fSlow5 * fTemp7;
			float fTemp8 = fSlow8 * fTemp7;
			float fTemp9 = fTemp8 - fRec6[1];
			fRec5[0] = fRec5[1] + fSlow7 * (fTemp8 - (fRec5[1] + fSlow2 * fTemp9 + fRec6[1]));
			fRec6[0] = fSlow7 * fTemp9 + fRec6[1];
			fRec7[0] = fSlow7 * fTemp6 + fRec7[1];
