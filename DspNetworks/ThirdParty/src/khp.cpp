...
struct _khp final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp2 = fTemp0 - (fSlow7 * (fSlow2 * fRec1[1] - (fRec0[1] - fSlow0 * fTemp1)) + fRec2[1]);
			float fTemp3 = fSlow6 * fTemp2;
			float fTemp4 = fTemp3 - fRec1[1];
			fRec0[0] = fRec0[1] + fSlow3 * (fTemp3 - (fSlow2 * fTemp4 + fRec1[1] + fRec0[1]));
			...
			float fTemp7 = fSlow7 * (fRec4[1] - fSlow0 * fTemp6 - fSlow2 * fRec5[1]) + fTemp5 - fRec6[1];
			float fTemp8 = fSlow6 * fTemp7;
			float fTemp9 = fTemp8 - fRec5[1];
			fRec4[0] = fSlow3 * (fTemp8 - (fRec5[1] + fSlow2 * fTemp9 + fRec4[1])) + fRec4[1];
