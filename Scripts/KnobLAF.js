...
KnobLaf.registerFunction("drawRotarySlider", function(g, obj)
{
	...
	g.setGradientFill([0xFF515151, 0.0, 0.0,
					   0xFF515151, 0.0, obj.area[3], false]);
	...
	g.setGradientFill([0xFF515151, 0.0, 0.0,
					   0xFF515151, 0.0, obj.area[3], true]);
...
Content.getComponent("KickVolume").setLocalLookAndFeel(KnobLaf);
Content.getComponent("KickPitch").setLocalLookAndFeel(KnobLaf);
Content.getComponent("KickPan").setLocalLookAndFeel(KnobLaf);
Content.getComponent("KickAttack").setLocalLookAndFeel(KnobLaf);
Content.getComponent("KickHold").setLocalLookAndFeel(KnobLaf);