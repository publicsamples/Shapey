...
struct Factory: public scriptnode::dll::StaticLibraryHostFactory
{
	Factory()
	{
		...
		registerPolyNode<project::fx<1>, project::fx<NUM_POLYPHONIC_VOICES>>();
		...
		registerPolyNode<project::TransFX<1>, project::TransFX<NUM_POLYPHONIC_VOICES>>();
		...
		registerDataNode<project::osc3_networkdata>();
		registerDataNode<project::osc4_networkdata>();
